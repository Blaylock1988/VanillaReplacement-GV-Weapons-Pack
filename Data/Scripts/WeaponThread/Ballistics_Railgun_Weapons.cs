...
namespace WeaponThread {   
    partial class Weapons {
        ...
        WeaponDefinition AryxRailgunTurret => new WeaponDefinition {
            ...
            {
                WeaponName = "Apollo 250mm Railgun Turret", // name of weapon in terminal
                ...
                Other = new OtherDef {
                    ...
                    MuzzleCheck = false,
                    Debug = false,
                    RestrictionRadius = 15, // Meters, radius of sphere disable this gun if another is present
        ...
        WeaponDefinition AryxRailgun => new WeaponDefinition {
            ...
            HardPoint = new HardPointDef 
            {
                WeaponName = "Artemis 250mm Railgun", // name of weapon in terminal
                DeviateShotAngle = 0.01f,
                AimingTolerance = 1f, // 0 - 180 firing angle
