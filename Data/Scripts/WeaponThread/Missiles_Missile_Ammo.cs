...
{ // Don't edit above this line
    ...
    {
        private AmmoDef Missiles_Missile_x150 => new AmmoDef
        {
            AmmoMagazine = "Missiles_Missile_x150",
            AmmoRound = "Missiles_Missile_x150",
        ...
        private AmmoDef Missiles_Missile_HomingPhase => new AmmoDef
        {
			...
			AreaEffect = new AreaDamageDef
			{
				...
				Base = new AreaInfluence
				{
					...
					EffectStrength = 800f, // For ewar it applies this amount per pulse/hit, non-ewar applies this as damage per tick per entity in area of influence. For radiant 0 == use spillover from BaseDamage, otherwise use this value.
				},
				Explosions = new ExplosionDef //Currently only works with Explosive, or if DetonateOnEnd = true
				{
					NoVisuals = false,
            ...
            Trajectory = new TrajectoryDef
            {
                ...
                Smarts = new SmartsDef
                {
                    ...
                    MaxTargets = 2, // Number of targets allowed before ending, 0 = unlimited
                    NoTargetExpire = false, // Expire without ever having a target at TargetLossTime
					OffsetRatio = 0.45f, // The ratio to offset the random dir (0 to 1) 
        ...
        private AmmoDef Missiles_Missile_x1 => new AmmoDef
        {
            AmmoMagazine = "Missiles_Missile_x1",
            AmmoRound = "Missiles_Missile_x1",
            HybridRound = false, //AmmoMagazine based weapon with energy cost
            EnergyCost = 0f, //(((EnergyCost * DefaultDamage) * ShotsPerSecond) * BarrelsPerShot) * ShotsPerBarrel
            BaseDamage = 1f,
            Mass = 1000f, // in kilograms
            ...
            Trajectory = new TrajectoryDef
            {
                ...
                Smarts = new SmartsDef
                {
                    ...
                    Aggressiveness = 3f, // controls how responsive tracking is.
                    MaxLateralThrust = 0.5f, // controls how sharp the trajectile may turn
                    TrackingDelay = 40, // Measured in Shape diameter units traveled.
                    MaxChaseTime = 0, // Measured in game ticks (6 = 100ms, 60 = 1 seconds, etc..).
                    OverideTarget = true, // when set to true ammo picks its own target, does not use hardpoint's.
                    MaxTargets = 2, // Number of targets allowed before ending, 0 = unlimited
                    NoTargetExpire = false, // Expire without ever having a target at TargetLossTime
