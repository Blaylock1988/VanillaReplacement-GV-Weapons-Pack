...
{ // Don't edit above this line
    partial class Weapons
    {
        private AmmoDef Missiles_Missile_x150 => new AmmoDef
        {
            ...
            {
                AmmoRound = "Missiles_Missile_x150_FlightStage",
                Fragments = 1,
                Degrees = 0,
                Reverse = false,
        ...
        private AmmoDef Missiles_Missile_x150_FlightStage => new AmmoDef
        {
            AmmoMagazine = "Energy",
            AmmoRound = "Missiles_Missile_x150_FlightStage",
            HybridRound = false, //AmmoMagazine based weapon with energy cost
        ...
        private AmmoDef Missiles_Missile_x1 => new AmmoDef
        {
            ...
            Shrapnel = new ShrapnelDef
            {
                AmmoRound = "Missiles_Missile_x1_FlightStage",
                Fragments = 1,
                Degrees = 0,
                Reverse = false,
                RandomizeDir = false, // randomzie between forward and backward directions
        ...
        private AmmoDef Missiles_Missile_x1_FlightStage => new AmmoDef
        {
            AmmoMagazine = "Energy",
            AmmoRound = "Missiles_Missile_x1_FlightStage",
            HybridRound = false, //AmmoMagazine based weapon with energy cost
