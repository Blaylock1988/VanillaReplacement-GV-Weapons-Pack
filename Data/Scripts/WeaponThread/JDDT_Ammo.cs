...
{ // Don't edit above this line
    partial class Weapons
    {
        private AmmoDef GV_Laser_JumpNull => new AmmoDef //Jump Null Rounds
        {
            ...
            EnergyCost = 0.00000025f, //(((EnergyCost * DefaultDamage) * ShotsPerSecond) * BarrelsPerShot) * ShotsPerBarrel
            BaseDamage = 0f,
            ...
            AreaEffect = new AreaDamageDef
            {
                ...
                Base = new AreaInfluence
                {
                    ...
                    EffectStrength = 1000000f, // For ewar it applies this amount per pulse/hit, non-ewar applies this as damage per tick per entity in area of influence. For radiant 0 == use spillover from BaseDamage, otherwise use this value.
                },
                ...
                Lines = new LineDef
                {
                    ...
                    Tracer = new TracerBaseDef
                    {
                        ...
                        Segmentation = new SegmentDef
                        {
                            ...
                            SegmentLength = 200f, // Uses the values below.
                            SegmentGap = 400f, // Uses Tracer textures and values
                            Speed = 500f, // meters per second
                            Color = Color(red: 1f, green: 15f, blue: 5f, alpha: 0.1f),
                            WidthMultiplier = 1f,
                            Reverse = true,
        ...
        private AmmoDef GV_Laser_JumpNull_Cosmetic => new AmmoDef //Jump Null Rounds cosmetic blue offset beam
        {
            ...
            EnergyCost = 0.000001f, //(((EnergyCost * DefaultDamage) * ShotsPerSecond) * BarrelsPerShot) * ShotsPerBarrel    (15 * 0.05 * 3600/60/60 = 0.75MW per tick)
            BaseDamage = 0f,
            Mass = 0f, // in kilograms
            ...
            AreaEffect = new AreaDamageDef
            {
                ...
                Pulse = new PulseDef // interval measured in game ticks (60 == 1 second), pulseChance chance (0 - 100) that an entity in field will be hit
                {
                    ...
                    Particle = new ParticleDef
                    {
                        ...
                        Color = Color(red: 1, green: 1, blue: 100, alpha: 100),
                        Offset = Vector(x: 0, y: 0, z: 0),
                        Extras = new ParticleOptionDef
                        {
                            Loop = false,
            ...
            AmmoGraphics = new GraphicDef
            {
                ...
                Particles = new AmmoParticleDef
                {
                    Ammo = new ParticleDef
                    {
                        Name = "", 
                        ShrinkByDistance = true,
                        Color = Color(red: 1, green: 2, blue: 1, alpha: 1f),
                        Offset = Vector(x: 0, y: 0, z: 0),
                        Extras = new ParticleOptionDef
                        {
                            Loop = false,
		...
		private AmmoDef GV_Laser_Pull => new AmmoDef
        {
            AmmoMagazine = "WebberMagazine",
            AmmoRound = "Singularity",
            HybridRound = true, //AmmoMagazine based weapon with energy cost
            EnergyCost = 0.00000025f, //(((EnergyCost * DefaultDamage) * ShotsPerSecond) * BarrelsPerShot) * ShotsPerBarrel
            BaseDamage = 1f,
            Mass = 0f, // in kilograms
            ...
            AmmoGraphics = new GraphicDef
            {
                ...
                Particles = new AmmoParticleDef
                {
                    Ammo = new ParticleDef
                    {
                        Name = "", //WC_Collision_Sparks_LargeGrid_Close
                        ShrinkByDistance = false,
                        Color = Color(red: 1, green: 0.1f, blue: 3, alpha: 1f),
                        Offset = Vector(x: 0, y: 0, z: 0),
                        Extras = new ParticleOptionDef
                        {
                            Loop = false,
                ...
                Lines = new LineDef
                {
                    ...
                    Tracer = new TracerBaseDef
                    {
                        ...
                        Segmentation = new SegmentDef
                        {
                            ...
                            SegmentLength = 80f, // Uses the values below.
                            SegmentGap = 60f, // Uses Tracer textures and values
                            Speed = 1200f, // meters per second
                            Color = Color(red: 10, green: 3, blue: 15f, alpha: 3),
                            WidthMultiplier = 1f,
                            Reverse = true,
                            UseLineVariance = true,
                            WidthVariance = Random(start: 0f, end: 0.1f),
                            ColorVariance = Random(start: 0.75f, end: 1.25f)
                        }
                    },
                    Trail = new TrailDef
                    {
                        ...
                        TextureMode = Normal,
                        DecayTime = 60,
                        Color = Color(red: 0, green: 0, blue: 0f, alpha: 0.1f),
                        Back = false,
                        CustomWidth = 6,
		...
		private AmmoDef GV_Laser_Pull_Shrapnel => new AmmoDef
        {
            AmmoMagazine = "Energy",
            AmmoRound = "NavFieldShrapnel",
            HybridRound = true, //AmmoMagazine based weapon with energy cost
            ...
            AreaEffect = new AreaDamageDef
            {
                AreaEffect = NavField, // Disabled = do not use area effect at all, Explosive, Radiant, AntiSmart, JumpNullField, JumpNullField, EnergySinkField, AnchorField, EmpField, OffenseField, NavField, DotField.
                Base = new AreaInfluence
                {
                    Radius = 50f, // the sphere of influence of area effects
                    EffectStrength = 1000000f, // For ewar it applies this amount per pulse/hit, non-ewar applies this as damage per tick per entity in area of influence. For radiant 0 == use spillover from BaseDamage, otherwise use this value.
		...
		/*private AmmoDef GV_Laser_Pull => new AmmoDef
        {
            ...
            AreaEffect = new AreaDamageDef
            {
                ...
                Base = new AreaInfluence
                {
                    Radius = 20f, // the sphere of influence of area effects
            ...
            AmmoGraphics = new GraphicDef
            {
                ...
                Particles = new AmmoParticleDef
                {
                    Ammo = new ParticleDef
                    {
                        Name = "WC_Collision_Sparks_LargeGrid_Close", //ShipWelderArc
                        ShrinkByDistance = false,
                        Color = Color(red: 1, green: 0.1f, blue: 3, alpha: 0.5f),
                        Offset = Vector(x: 0, y: 0, z: 0),
                        Extras = new ParticleOptionDef
                        {
                            Loop = false,
                    ...
                    Hit = new ParticleDef
                    {
                        ...
                        ApplyToShield = true,
                        ShrinkByDistance = true,
                        Color = Color(red: 0, green: 0f, blue: 0f, alpha: 2),
                        Offset = Vector(x: 0, y: 0, z: 0),
                        Extras = new ParticleOptionDef
                        {
                            Loop = true,
                ...
                Lines = new LineDef
                {
                    ...
                    Tracer = new TracerBaseDef
                    {
                        ...
                        Length = 1f,
                        Width = 0.3f,
                        Color = Color(red: 2, green: 0, blue: 4f, alpha: 1),
                        VisualFadeStart = 0, // Number of ticks the weapon has been firing before projectiles begin to fade their color
                        VisualFadeEnd = 0, // How many ticks after fade began before it will be invisible.
                        Textures = new[] {// WeaponLaser, ProjectileTrailLine, WarpBubble, etc..
                            "WeaponLaser",
                        ...
                        Segmentation = new SegmentDef
                        {
                            ...
                            SegmentLength = 80f, // Uses the values below.
                            SegmentGap = 60f, // Uses Tracer textures and values
                            Speed = 600f, // meters per second
                            Color = Color(red: 4, green: 1, blue: 6f, alpha: 1),
                            WidthMultiplier = 1f,
                            Reverse = false,
                            UseLineVariance = true,
                            WidthVariance = Random(start: 0f, end: 0.1f),
