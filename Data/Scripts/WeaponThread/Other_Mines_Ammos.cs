...
{ // Don't edit above this line
    partial class Weapons
    {
		private AmmoDef Others_Mine => new AmmoDef
        {
            ...
            Health = 150, // 0 = disabled, otherwise how much damage it can take from other trajectiles before dying.
            BackKickForce = 0f,
            DecayPerShot = 0f,
            ...
            AreaEffect = new AreaDamageDef
            {
                ...
                Explosions = new ExplosionDef
                {
                    ...
                    NoDeformation = false,
                    Scale = 1,
                    CustomParticle = "MD_TorpedoSlowBlast",//  MXA_MissileExplosion
