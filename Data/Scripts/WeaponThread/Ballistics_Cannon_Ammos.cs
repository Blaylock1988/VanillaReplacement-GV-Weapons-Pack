...
{ // Don't edit above this line
    partial class Weapons
    {
        private AmmoDef BallisticCannonAP => new AmmoDef
        {
            ...
            AreaEffect = new AreaDamageDef
            {
                ...
                Base = new AreaInfluence
                {
                    ...
                    EffectStrength = 6000f, // For ewar it applies this amount per pulse/hit, non-ewar applies this as damage per tick per entity in area of influence. For radiant 0 == use spillover from BaseDamage, otherwise use this value.
                },
        ...
        private AmmoDef BallisticCannonAP_Shrapnel => new AmmoDef
        {
            AmmoMagazine = "Energy",
            AmmoRound = "BallisticCannonAP_Shrapnel",
            HybridRound = false, //AmmoMagazine based weapon with energy cost
            ...
            AreaEffect = new AreaDamageDef
            {
                ...
                Base = new AreaInfluence
                {
                    ...
                    EffectStrength = 10000f, // For ewar it applies this amount per pulse/hit, non-ewar applies this as damage per tick per entity in area of influence. For radiant 0 == use spillover from BaseDamage, otherwise use this value.
                },
                Pulse = new PulseDef // interval measured in game ticks (60 == 1 second), pulseChance chance (0 - 100) that an entity in field will be hit
                {
                    Interval = 0,
            ...
            Trajectory = new TrajectoryDef
            {
                ...
                MaxLifeTime = 0, // 0 is disabled, Measured in game ticks (6 = 100ms, 60 = 1 seconds, etc..).
                AccelPerSec = 0f,
                DesiredSpeed = 500f, // DO NOT SET HIGHER THAN 4100
                MaxTrajectory = 10f,
                FieldTime = 0, // 0 is disabled, a value causes the projectile to come to rest, spawn a field and remain for a time (Measured in game ticks, 60 = 1 second)
                GravityMultiplier = 0f, // Gravity multiplier, influences the trajectory of the projectile, value greater than 0 to enable.
                SpeedVariance = Random(start: 0, end: 20), // subtracts value from DesiredSpeed
                RangeVariance = Random(start: 0, end: 5), // subtracts value from MaxTrajectory
                MaxTrajectoryTime = 0, // How long the weapon must fire before it reaches MaxTrajectory.
                Smarts = new SmartsDef
                {
                    Inaccuracy = 0f, // 0 is perfect, hit accuracy will be a random num of meters between 0 and this value.
